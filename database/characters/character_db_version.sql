...
-- Filename   : character_db_version.sql
-- DB Version : 1.0
...
CREATE TABLE `character_db_version` (
  `required_12763_00_characters_pvpstats` bit(1) DEFAULT NULL
...
INSERT INTO `character_db_version` (`required_12763_00_characters_pvpstats`) VALUES (NULL);
...
-- End-Of-File: character_db_version.sql
