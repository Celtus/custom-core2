...
-- Filename   : playerbot_saved_data.sql
-- DB Version : 1.0
...
CREATE TABLE `playerbot_saved_data` (
  ...
  PRIMARY KEY (`guid`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 ROW_FORMAT=FIXED COMMENT='Persistent Playerbot settings per alt';
...
-- End-Of-File: playerbot_saved_data.sql
