...
-- Filename   : areatrigger_involvedrelation.sql
-- DB Version : 1.0
...
INSERT INTO `areatrigger_involvedrelation` (`id`, `quest`) VALUES (4899,11890);
INSERT INTO `areatrigger_involvedrelation` (`id`, `quest`) VALUES (4950,12036);
INSERT INTO `areatrigger_involvedrelation` (`id`, `quest`) VALUES (4963,11652);
INSERT INTO `areatrigger_involvedrelation` (`id`, `quest`) VALUES (4986,12263);
INSERT INTO `areatrigger_involvedrelation` (`id`, `quest`) VALUES (5003,12506);
INSERT INTO `areatrigger_involvedrelation` (`id`, `quest`) VALUES (5400,13816);
INSERT INTO `areatrigger_involvedrelation` (`id`, `quest`) VALUES (5401,13607);
...
-- End-Of-File: areatrigger_involvedrelation.sql
