...
INSERT INTO `npc_codebox_codes` (`npc_id`, `code`, `uses`, `aura_id`, `item_id`, `quantity`) VALUES (2943,'murlocsuit',3,0,33079,1);
INSERT INTO `npc_codebox_codes` (`npc_id`, `code`, `uses`, `aura_id`, `item_id`, `quantity`) VALUES (2943,'surprise',-1,-1,0,1);
INSERT INTO `npc_codebox_codes` (`npc_id`, `code`, `uses`, `aura_id`, `item_id`, `quantity`) VALUES (7951,'murlocsuit',3,0,33079,1);
...
INSERT INTO `npc_codebox_codes` (`npc_id`, `code`, `uses`, `aura_id`, `item_id`, `quantity`) VALUES (16076,'murlocblue',5,0,20371,1);
